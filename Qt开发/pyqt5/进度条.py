...
class WorkerThread(QThread):
    ...
    def run(self):
        ...
        for i, task in enumerate(self.tasks):
            ...
            # 发射信号更新进度条
            self.update_progress.emit((i + 1) * (100 // total_tasks), f"正在处理任务: {task}")
        
        # 任务完成后关闭进度对话框
        self.update_progress.emit(100, "所有任务已完成")
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # 初始化进度对话框
        self.progress_dialog = QProgressDialog("正在处理任务...", "取消", 0, 100, self)
