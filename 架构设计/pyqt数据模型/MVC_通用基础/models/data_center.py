...
class DataCenter(QObject):
    ...
    def text(self, value:TextData):
        if value.text != self._text_data.text:
            ...
            self.model_signal.emit(SignalData(signal_type="text_changed", params={"new_text": value}))  
    ...
    def thread_data(self, value:TextData):
        if value.text != self._thread_data.text:
            ...
            self.model_signal.emit(SignalData(signal_type="thread_data_changed", params={"new_thread_data": value}))  
