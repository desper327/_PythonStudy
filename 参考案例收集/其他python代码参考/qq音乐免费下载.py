...
response = requests.get(f'http://www.kuwo.cn/search/list?key={name}')#(f'http://c.y.qq.com/soso/fcgi-bin/client_search_cp?p=1&n=10&w={name}')
...
tb = pt.PrettyTable()
tb.field_names = ['1', '哪里都是你', '队长 ', '里都是你哪']
music_info_list = []
count = 0
